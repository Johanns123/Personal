...
uint32_t v_bat[2];	//variável para armazenar os valores do AD

/*Funções que ainda não são possíveis de se encapsular*/
void setup_Hardware()
{
	HAL_Init();
	SystemClock_Config();
	...
	/* USER CODE BEGIN 2 */
	HAL_ADC_Start_DMA(&hadc1, v_bat, 2);	//start o ADC com DMA
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, AIN2_Pin|AIN1_Pin|BIN2_Pin|BIN1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : Encoder_D1_Pin */
  GPIO_InitStruct.Pin = Encoder_D1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(Encoder_D1_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : Encoder_E1_Pin INT_MPU_Pin */
  GPIO_InitStruct.Pin = Encoder_E1_Pin|INT_MPU_Pin;
